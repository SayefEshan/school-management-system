...
@section('breadcrumb')
    <span class="breadcrumb-item active">Edit OTP Whitelist Entry</span>
@endsection

@section('content')
    <div class="card">
        <div class="card-body p-4">
            {{ Form::model($whitelist, ['route' => ['otp-whitelist.update', $whitelist->id], 'method' => 'put']) }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12 text-end">
                            ...
                            <x-primary-button type="submit">Update Entry</x-primary-button>
                        </div>
                    </div>
                </div>
            </div>
